...
* @license MIT
*
* BUILT: Fri Nov 30 2018 13:17:15 GMT+0100 (GMT+01:00)
*/;
...
function componentHex(component) {
  ...
  const hex$$1 = integer.toString(16);
...
class Color {
  ...
  init(a = 0, b = 0, c = 0, d = 0, space = 'rgb') {
    ...
    if (typeof a === 'number') {
      ...
      if (isRgb.test(a)) {
        ...
        const _rgb$exec$slice$map = rgb.exec(noWhitespace).slice(1, 4).map(v => parseInt(v)),
              _rgb$exec$slice$map2 = _slicedToArray(_rgb$exec$slice$map, 3),
              _a = _rgb$exec$slice$map2[0],
              _b = _rgb$exec$slice$map2[1],
              _c = _rgb$exec$slice$map2[2];
        ...
        const _hex$exec$map = hex.exec(sixDigitHex(a)).map(hexParse),
  ...
  */
  ...
  xyz() {
    ...
    const _this$rgb = this.rgb(),
          r255 = _this$rgb._a,
          g255 = _this$rgb._b,
          b255 = _this$rgb._c;

    const _map = [r255, g255, b255].map(v => v / 255),
  ...
  hsl() {
    // Get the rgb values
    const _this$rgb2 = this.rgb(),
          _a = _this$rgb2._a,
          _b = _this$rgb2._b,
          _c = _this$rgb2._c;

    const _map3 = [_a, _b, _c].map(v => v / 255),
  ...
  cmyk() {
    ...
    const _this$rgb3 = this.rgb(),
          _a = _this$rgb3._a,
          _b = _this$rgb3._b,
          _c = _this$rgb3._c;

    const _map5 = [_a, _b, _c].map(v => v / 255),
  ...
  */
  ...
  toHex() {
    let _this$rgb4 = this.rgb(),
        _a = _this$rgb4._a,
        _b = _this$rgb4._b,
        _c = _this$rgb4._c;

    let _map7 = [_a, _b, _c].map(componentHex),
...
extend([Svg$1, Symbol$1, Image, Pattern, Marker], getMethodsFor('viewbox'));
