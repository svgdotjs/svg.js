...
describe('SVG.Runner', function () {
  ...
  var runFn: jasmine.Spy = jasmine.createSpy('runFn')
  ...
  describe('sanitise()', function () {
    it('can handle all form of input', function () {
      ...
      expect(fn(200)).toEqual(jasmine.objectContaining({
        duration: 200,
        delay: SVGJS.defaults.timeline.delay,
        when: 'last',
        times: 1,
        wait: 0,
        swing: false
      ...
      expect(fn(runFn as any)).toEqual(jasmine.objectContaining({
        duration: runFn,
        delay: SVGJS.defaults.timeline.delay,
        when: 'last',
        times: 1,
      ...
      expect(fn({ delay: 200 } as SVGJS.TimeLike)).toEqual(jasmine.objectContaining({
        duration: SVGJS.defaults.timeline.duration,
        delay: 200,
        when: 'last',
        times: 1,
        wait: 0,
      ...
      expect(fn({ times: 3, delay: 200, when: 'now', swing: true, wait: 200 } as SVGJS.TimeLike)).toEqual(jasmine.objectContaining({
        duration: SVGJS.defaults.timeline.duration,
        delay: 200,
        when: 'now',
        times: 3,
  ...
  describe('())', function () {
    it('creates a runner with defaults', function () {
      var runner = new SVGJS.Runner()
      expect(runner instanceof SVGJS.Runner).toBe(true)
      expect((runner as any)._duration).toBe(SVGJS.defaults.timeline.duration)
      expect((runner as any)._stepper instanceof SVGJS.Ease).toBe(true)
    })

    it('creates a runner with duration set', function () {
      var runner = new SVGJS.Runner(1000)
      expect(runner instanceof SVGJS.Runner).toBe(true)
      expect((runner as any)._duration).toBe(1000)
      expect((runner as any)._stepper instanceof SVGJS.Ease).toBe(true)
    })

    it('creates a runner with controller set', function () {
      var runner = new SVGJS.Runner(runFn)
      expect(runner instanceof SVGJS.Runner).toBe(true)
      expect((runner as any)._duration).toBeFalsy()
      expect((runner as any)._stepper instanceof SVGJS.Controller).toBe(true)
    })
  })
  ...
  describe('queue()', function () {
    it('adds another closure to the runner', function () {
      ...
      expect((runner as any)._queue[0]).toEqual(jasmine.objectContaining({
        initialiser: initFn,
        initialised: false,
        runner: runFn,
        finished: false
  ...
  describe('step()', function () {
    ...
    it('calls initFn on every step if its declaritive', function () {
      var runner = new SVGJS.Runner(new SVGJS.Controller())
      runner.queue(initFn, runFn, true)
    ...
    function getLoop(r: SVGJS.Runner) {
    ...
    it('steps forward a certain time', function () {
      ...
      var r = new SVGJS.Runner(1000).loop(10, false, 100)
      r.queue(null, spy)
      ...
      describe('without wait', function () {
        describe('unreversed', function () {
          describe('nonswinging', function () {
            it('does behave correctly at the end of an even loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(6, false)
            ...
            it('does behave correctly at the end of an uneven loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(5, false)
              runner.queue(null, spy)
          ...
          describe('swinging', function () {
            it('does behave correctly at the end of an even loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(6, true)
              runner.queue(null, spy)
            ...
            it('does behave correctly at the end of an uneven loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(5, true)
              runner.queue(null, spy)
        ...
        describe('reversed', function () {
          describe('nonswinging', function () {
            it('does behave correctly at the end of an even loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(6, false).reverse()
              runner.queue(null, spy)
            ...
            it('does behave correctly at the end of an uneven loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(5, false).reverse()
              runner.queue(null, spy)
          ...
          describe('swinging', function () {
            it('does behave correctly at the end of an even loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(6, true).reverse()
              runner.queue(null, spy)
            ...
            it('does behave correctly at the end of an uneven loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(5, true).reverse()
              runner.queue(null, spy)
      ...
      describe('with wait', function () {
        describe('unreversed', function () {
          describe('nonswinging', function () {
            it('does behave correctly at the end of an even loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(6, false, 100)
              runner.queue(null, spy)
            ...
            it('does behave correctly at the end of an uneven loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(5, false, 100)
              runner.queue(null, spy)
          ...
          describe('swinging', function () {
            it('does behave correctly at the end of an even loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(6, true, 100)
              runner.queue(null, spy)
            ...
            it('does behave correctly at the end of an uneven loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(5, true, 100)
              runner.queue(null, spy)
        ...
        describe('reversed', function () {
          describe('nonswinging', function () {
            it('does behave correctly at the end of an even loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(6, false, 100).reverse()
              runner.queue(null, spy)
            ...
            it('does behave correctly at the end of an uneven loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(5, false, 100).reverse()
              runner.queue(null, spy)
          ...
          describe('swinging', function () {
            it('does behave correctly at the end of an even loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(6, true, 100).reverse()
              runner.queue(null, spy)
            ...
            it('does behave correctly at the end of an uneven loop', function () {
              var spy = jasmine.createSpy('stepper')
              var runner = new SVGJS.Runner(1000).loop(5, true, 100).reverse()
              runner.queue(null, spy)
  ...
  describe('duration()', function () {
    it('return the full duration of the runner including all loops and waits', function () {
      var runner = new SVGJS.Runner(800).loop(10, true, 200)
  ...
  describe('loop()', function () {
    it('makes this runner looping', function () {
      var runner = new SVGJS.Runner(1000).loop(5)
  ...
  describe('loops()', function () {
    it('get the loops of a runner', function () {
      var spy = jasmine.createSpy('stepper')
      var runner = new SVGJS.Runner(1000).queue(null, spy)
    ...
    it('sets the loops of the runner in a loop', function () {
      var spy = jasmine.createSpy('stepper')
      var runner = new SVGJS.Runner(1000).loop(5, true, 500).queue(null, spy)
  ...
  describe('progress()', function () {
    ...
    it('gets the progress of a runner when looping', function () {
      var spy = jasmine.createSpy('stepper')
      var runner = new SVGJS.Runner(800).queue(null, spy).loop(10, false, 200) // duration should be 9800
    ...
    it('sets the progress of a runner when looping', function () {
      var spy = jasmine.createSpy('stepper')
      var runner = new SVGJS.Runner(800).queue(null, spy).loop(10, false, 200)
  ...
  describe('position()', function () {
    ...
    it('gets the position of a runner when looping', function () {
      var spy = jasmine.createSpy('stepper')
      var runner = new SVGJS.Runner(1000).loop(5, true, 100).queue(null, spy)
  ...
  describe('timeline()', function () {
    ...
    it('sets a timeline to be bound to the runner', function () {
      var runner = new SVGJS.Runner()
      var timeline = new SVGJS.Timeline()
  ...
  describe('animate()', function () {
    it('creates a new runner scheduled after the first', function () {
      ...
      expect(timeline.schedule() as any).toEqual(jasmine.arrayContaining([
  ...
  describe('reverse()', function () {
    ...
    it('reverses the runner', function () {
      var spy = jasmine.createSpy('stepper')
      var runner = new SVGJS.Runner(1000).reverse().queue(null, spy)
      runner.step(750)
      expect(spy).toHaveBeenCalledWith(0.25)
    })
  })
