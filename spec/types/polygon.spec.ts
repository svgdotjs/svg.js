...
describe('Polygon', function () {
  var polygon: SVGJS.Polygon

  beforeEach(function () {
    polygon = helpers.draw.polygon('0,0 100,0 100,100 0,100')
  })
  ...
  describe('plot()', function () {
    ...
    it('clears the array cache when a value is passed', function () {
      polygon = helpers.draw.polygon([100, 50, 75, 20, 200, 100])
      expect(polygon._array instanceof SVGJS.PointArray).toBeTruthy()
    ...
    it('applies a given polygon string value as is', function () {
      ...
      polygon = helpers.draw.polygon(polyString)
