...
describe('Polyline', function () {
  var polyline: SVGJS.Polyline

  beforeEach(function () {
    polyline = helpers.draw.polyline('0,0 100,0 100,100 0,100')
  })
  ...
  describe('()', function () {
    it('falls back to a single point without an argument', function () {
      polyline = helpers.draw.polyline()
  ...
  describe('plot()', function () {
    it('change the points attribute of the underlying polyline node when a string is passed', function () {
      var pointString = '100,50 75,20 200,100'
        , pointArray = new SVGJS.PointArray(pointString)
    ...
    it('clears the array cache when a value is passed', function () {
      polyline = helpers.draw.polyline([100, 50, 75, 20, 200, 100])
      expect(polyline._array instanceof SVGJS.PointArray).toBeTruthy()
    ...
    it('applies a given polyline string value as is', function () {
      ...
      polyline = helpers.draw.polyline(polyString)
