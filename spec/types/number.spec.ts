...
describe('Number', function () {
  var number: SVGJS.Number

  beforeEach(function () {
    number = new SVGJS.Number
  })
  ...
  describe('plus()', function () {
    it('returns a new instance', function () {
      ...
      expect(number.plus(4.5) instanceof SVGJS.Number).toBeTruthy()
    })
    ...
    it('use the unit of this number as the unit of the returned number by default', function () {
      expect(new SVGJS.Number('12s').plus('3%').unit).toBe('s')
    })
  ...
  describe('minus()', function () {
    ...
    it('use the unit of this number as the unit of the returned number by default', function () {
      expect(new SVGJS.Number('12s').minus('3%').unit).toBe('s')
    })
    it('use the unit of the passed number as the unit of the returned number when this number as no unit', function () {
  ...
  describe('times()', function () {
    ...
    it('use the unit of this number as the unit of the returned number by default', function () {
      expect(new SVGJS.Number('12s').times('3%').unit).toBe('s')
    })
    it('use the unit of the passed number as the unit of the returned number when this number as no unit', function () {
  ...
  describe('divide()', function () {
    ...
    it('use the unit of this number as the unit of the returned number by default', function () {
      expect(new SVGJS.Number('12s').divide('3%').unit).toBe('s')
    })
    it('use the unit of the passed number as the unit of the returned number when this number as no unit', function () {
