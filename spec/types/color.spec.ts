...
describe('Color', function () {
	var color: SVGJS.Color

	beforeEach(function () {
		color = new SVGJS.Color({ r: 0, g: 102, b: 255 } as SVGJS.ColorLike)
	})
	...
	describe('construct: constructs a color in different formats', () => {
		...
		it('constructs a color from an object in the correct color space', () => {
			...
			// Try in rgb
			let color = new SVGJS.Color({ r: 255, g: 0, b: 128 } as SVGJS.ColorLike)
			...
			// Try in cmyk
			let color2 = new SVGJS.Color({ c: 20, y: 15, m: 10, k: 5 } as SVGJS.ColorLike)
		...
		it('constructs a color from an array', () => {
			let color = new SVGJS.Color([30, 24, 50])
		...
		it('constructs a color from an array with space given', () => {
			let color = new SVGJS.Color([50, 50, 5], 'lab')
		...
		it('correclty parses an rgb string', () => {
			let color = new SVGJS.Color('rgb(255,0,128)')
			expect(color.r).toBe(255)
			expect(color.g).toBe(0)
			expect(color.b).toBe(128)
		})
	...
	describe('color spaces: The color spaces supported by our library', () => {
		...
		describe('lab()', () => {
			it('can convert rgb to lab', () => {
				let color = new SVGJS.Color(255, 0, 128)
				let lab = color.lab()
			...
			it('can convert from lab to rgb', () => {
				let lab = new SVGJS.Color(54.88, 84.55, 4.065, 'lab')
				let rgb = lab.rgb()
			...
			it('is invertable', () => {
				let { r, g, b } = new SVGJS.Color(255, 0, 128).lab().rgb()
			...
			it('handles black', () => {
				let color = new SVGJS.Color(0, 0, 0).lab().rgb()
			...
			it('handles white', () => {
				let color = new SVGJS.Color(255, 255, 255).lab().rgb()
		...
		describe('lch()', () => {
			...
			it('can convert from lch to rgb', () => {
				let lch = new SVGJS.Color(54.88, 84.65, 2.75, 'lch')
				let rgb = lch.rgb()
				expect(rgb.r).toBeCloseTo(255, 0)
				expect(rgb.g).toBeCloseTo(0, 0)
				expect(rgb.b).toBeCloseTo(128, 0)
			...
			it('is invertable', () => {
				let { r, g, b } = new SVGJS.Color(255, 0, 128).lch().rgb()
				expect(r).toBeCloseTo(255, 0)
				expect(g).toBeCloseTo(0, 0)
				expect(b).toBeCloseTo(128, 0)
			})
			...
			it('handles black', () => {
				let color = new SVGJS.Color(0, 0, 0).lch().rgb()
				expect(color.r).toBeCloseTo(0, 0)
				expect(color.g).toBeCloseTo(0, 0)
				expect(color.b).toBeCloseTo(0, 0)
				expect(color.toHex()).toBe('#000000')
			...
			it('handles white', () => {
				let color = new SVGJS.Color(255, 255, 255).lch().rgb()
				expect(color.r).toBeCloseTo(255, 0)
				expect(color.g).toBeCloseTo(255, 0)
				expect(color.b).toBeCloseTo(255, 0)
				expect(color.toHex()).toBe('#ffffff')
		...
		describe('hsl()', () => {
			...
			it('can convert from hsl to rgb', () => {
				let hsl = new SVGJS.Color(329.88, 100, 50, 'hsl')
				let rgb = hsl.rgb()
				expect(rgb.r).toBeCloseTo(255, 0)
				expect(rgb.g).toBeCloseTo(0, 0)
				expect(rgb.b).toBeCloseTo(128, 0)
			...
			it('is invertable', () => {
				let { r, g, b } = new SVGJS.Color(255, 0, 128).hsl().rgb()
				expect(r).toBeCloseTo(255, 0)
				expect(g).toBeCloseTo(0, 0)
				expect(b).toBeCloseTo(128, 0)
			})
			...
			it('handles black', () => {
				let color = new SVGJS.Color(0, 0, 0).hsl().rgb()
				expect(color.r).toBeCloseTo(0, 0)
				expect(color.g).toBeCloseTo(0, 0)
				expect(color.b).toBeCloseTo(0, 0)
				expect(color.toHex()).toBe('#000000')
			...
			it('handles white', () => {
				let color = new SVGJS.Color(255, 255, 255).hsl().rgb()
				expect(color.r).toBeCloseTo(255, 0)
				expect(color.g).toBeCloseTo(255, 0)
				expect(color.b).toBeCloseTo(255, 0)
				expect(color.toHex()).toBe('#ffffff')
		...
		describe('cmyk()', () => {
			...
			it('can convert from cmyk to rgb', () => {
				let color = new SVGJS.Color(0, 1, 0.49, 0, 'cmyk')
				let rgb = color.rgb()
			...
			it('is invertable', () => {
				let { r, g, b } = new SVGJS.Color(255, 0, 128).cmyk().rgb()
				expect(r).toBeCloseTo(255, 0)
				expect(g).toBeCloseTo(0, 0)
				expect(b).toBeCloseTo(128, 0)
			})
			...
			it('handles black', () => {
				let color = new SVGJS.Color(0, 0, 0).cmyk().rgb()
				expect(color.r).toBeCloseTo(0, 0)
				expect(color.g).toBeCloseTo(0, 0)
				expect(color.b).toBeCloseTo(0, 0)
				expect(color.toHex()).toBe('#000000')
			...
			it('handles white', () => {
				let color = new SVGJS.Color(255, 255, 255).cmyk().rgb()
				expect(color.r).toBeCloseTo(255, 0)
				expect(color.g).toBeCloseTo(255, 0)
				expect(color.b).toBeCloseTo(255, 0)
				expect(color.toHex()).toBe('#ffffff')
